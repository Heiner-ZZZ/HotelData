...
ROUTE_RULES = [
    ...
    AccessRule("/api/amenities/guest",
    ...
    AccessRule("/api/billing/invoices",
    ...
    AccessRule("/api/management/products",
        roles=("super_admin", "admin_sistema", "hotel_partner", "gerente_hotel", "revenue_manager", "marketing_hotelero", "operador_datos", "auditor_datos", "cliente", "maintenance"),
    ),
    AccessRule("/api/management/properties",
        roles=("super_admin", "admin_sistema", "hotel_partner", "gerente_hotel", "revenue_manager", "marketing_hotelero", "operador_datos", "auditor_datos", "cliente", "maintenance"),
    ),
    ...
    AccessRule("/hotels", roles=("cliente", "super_admin", "admin_sistema", "operador_datos", "auditor_datos", "hotel_partner", "gerente_hotel", "revenue_manager", "marketing_hotelero", "maintenance")),
