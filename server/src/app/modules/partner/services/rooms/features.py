...
def _feature_icon(label: str) -> str:
    ...
    icon_map: dict[str, str] = {
        ...
        "suelo radiante": "heat_pump",
        "ventanas insonorizadas": "volume_down",
