"""Core room type CRUD operations."""
...
def _validate_room_type(
    prop_id: int, name: str, room_type_id: str | None = None,
    max_adults: Any = None, base_rate: Any = None, room_number: str = "",
) -> str:
...
def create_room_type(
    prop_id: int, *, name: str, description: str, max_adults: Any,
    ...
    register_action(
        ...
        action="create", summary=f"Tipo de habitación '{clean_name}' creado",
        changed_by=changed_by,
        metadata={"name": clean_name, "room_number": clean_room_number, "floor": payload["floor"],
                  "max_adults": safe_positive_int(max_adults, 1), "view": clean_text(view),
                  "smoking": safe_bool(smoking), "accessible": safe_bool(accessible)},
    )
    return document
...
def update_room_type(
    room_type_id: str, *, name: str, description: str, max_adults: Any,
    max_children: Any, base_capacity: Any, base_rate: Any = None,
    is_active: Any = True, room_number: str = "", floor: str = "",
    view: str = "", smoking: Any = False, accessible: Any = False,
    is_roh: Any = False, changed_by: str = "system",
    ...
    register_action(
        ...
        changed_by=changed_by, metadata={"name": clean_name},
    )
    return document
...
def delete_room_type(room_type_id: str, changed_by: str = "system") -> dict[str, Any] | None:
    ...
    register_action(
        ...
        changed_by=changed_by, metadata={"name": room_name},
    )
