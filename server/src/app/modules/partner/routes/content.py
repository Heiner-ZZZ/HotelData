...
def property_content_update_api(prop_id: int, payload: dict = Body(...), current_user: dict = Depends(require_prop_permission("properties.update"))):
    saved = save_partner_hotel_content(
        prop_id,
...
def property_image_add_api(prop_id: int, payload: dict = Body(...), current_user: dict = Depends(require_prop_permission("properties.update"))):
...
async def property_image_upload_api(prop_id: int, file: UploadFile, current_user: dict = Depends(require_prop_permission("properties.update"))):
...
def property_image_delete_api(prop_id: int, image_url: str = Query(...), current_user: dict = Depends(require_prop_permission("properties.update"))):
...
def property_image_reorder_api(prop_id: int, payload: dict = Body(...), current_user: dict = Depends(require_prop_permission("properties.update"))):
