...
import { RatesCalendarDashboardPageComponent } from './rates-calendar-dashboard-page';

describe('RatesCalendarDashboardPageComponent (gate de exportación)', () => {
  function setup(hasDownload: boolean) {
    ...
    TestBed.configureTestingModule({
      imports: [RatesCalendarDashboardPageComponent],
      providers: [
        provideHttpClient(),
    ...
    const fixture = TestBed.createComponent(RatesCalendarDashboardPageComponent);
