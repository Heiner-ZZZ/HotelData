...
import { RoomStatusDashboardPageComponent } from './room-status-dashboard-page';

describe('RoomStatusDashboardPageComponent (gate de exportación)', () => {
  function setup(hasDownload: boolean) {
    ...
    TestBed.configureTestingModule({
      imports: [RoomStatusDashboardPageComponent],
      providers: [
        provideHttpClient(),
    ...
    const fixture = TestBed.createComponent(RoomStatusDashboardPageComponent);
