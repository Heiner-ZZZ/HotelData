...
export function mapPolicies(dto: PoliciesDto): PoliciesViewModel {
  ...
  return {
    ...
    earlyCheckInEnabled: dto.policies.early_check_in_enabled ?? true,
    earlyCheckInCourtesyMinutes: dto.policies.early_check_in_courtesy_minutes ?? 60,
    earlyCheckInDefaultFee: dto.policies.early_check_in_default_fee ?? 0,
    lateCheckoutEnabled: dto.policies.late_checkout_enabled ?? true,
    lateCheckoutCourtesyMinutes: dto.policies.late_checkout_courtesy_minutes ?? 60,
    lateCheckoutDefaultFee: dto.policies.late_checkout_default_fee ?? 0,
    guaranteedReservation: dto.policies.guaranteed_reservation ?? false,
    lateArrivalCutoff: dto.policies.late_arrival_cutoff || '23:59',
    noShowExecution: dto.policies.no_show_execution || 'next_day',
...
export function mapPoliciesPayload(vm: PoliciesViewModel): PoliciesSaveDto {
  return {
    ...
    early_check_in_enabled: vm.earlyCheckInEnabled,
    early_check_in_courtesy_minutes: vm.earlyCheckInCourtesyMinutes,
    early_check_in_default_fee: vm.earlyCheckInDefaultFee,
    late_checkout_enabled: vm.lateCheckoutEnabled,
    late_checkout_courtesy_minutes: vm.lateCheckoutCourtesyMinutes,
    late_checkout_default_fee: vm.lateCheckoutDefaultFee,
    guaranteed_reservation: vm.guaranteedReservation,
    late_arrival_cutoff: vm.lateArrivalCutoff,
    no_show_execution: vm.noShowExecution,
