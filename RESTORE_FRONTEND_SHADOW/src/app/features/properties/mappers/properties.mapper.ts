...
export function mapPropertiesListResponse(
  dto: PropertiesListResponseDto
): PropertiesListViewModel {
  return {
...
export function mapPropertyDetailResponse(
  dto: PropertyDetailResponseDto
): PropertyDetailViewModel {
  return {
    ...
    profileFacts: [
      ...
      { label: 'Marca', value: dto.hotel.prop_brand_bool ? 'Si' : 'No' },
      {
        ...
        value: dto.hotel.prop_location_score1?.toString() || 'N/D'
      }
    ],
    masterFacts: [
      ...
      {
        label: 'Description',
        value: dto.master_hotel.description || dto.hotel.description || 'N/D'
      },
      {
        label: 'Rating',
        value:
          dto.master_hotel.rating?.toString() ||
          dto.hotel.prop_starrating?.toString() ||
          'N/D'
      }
    ]
  };
